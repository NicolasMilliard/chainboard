...
const SnowboardSize = () => {
  const { size, handleSnowboardSize, setIsDisplay } = useStateContext();
  ...
  return (
    <div className='mb-20'>
        ...
        <div className='flex flex-wrap items-center'>
          ...
          <input id='snowboard-size' type='range' min='138' max='167' className='chainboard-input-range' onChange={handleSnowboardSize} onInput={handleInputChange} />
